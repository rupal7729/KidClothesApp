<?php 
    ...
    $sql = "SELECT * FROM producttb p join categorytb c on p.categoryid=c.categoryid WHERE c.categoryid=3";
                                ...
                                <div class="single-product mb-60">
                                    ...
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                         ...
                                         <h4>
                                            <a href="sleeperSet.php?pid=<?php echo $id;?>&list=wishlist" style="color: red;" class="heart" ><i class="far fa-heart" id="iheart"></i></a>
                                        </h4>
