<?php 
    ...
    $sql = "SELECT * FROM producttb p join categorytb c on p.categoryid=c.categoryid WHERE c.categoryid=8 and productFor = 'baby boy'";
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6" id="data">
                                <div class="single-product mb-60">
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <h4>
                                            <a href="collectionboy.php?pid=<?php echo $id;?>&list=wishlist" style="color: red;" class="heart" ><i class="far fa-heart" id="iheart"></i></a>
                                        </h4>
